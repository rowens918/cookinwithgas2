...
public class RecipeWidget extends AppWidgetProvider {
    ...
    public static CharSequence newWidgetText;
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        views.setTextViewText(R.id.appwidget_text, newWidgetText);
    ...
    public static void setRecipeWidgetText(Context context, String ingredients) {
        newWidgetText = ingredients;
        ...
        remoteViews.setTextViewText(R.id.appwidget_text, newWidgetText);
